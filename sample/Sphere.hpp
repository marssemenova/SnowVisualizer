...
public:
    // ctor/dtor
    Sphere(float radius=1.0f, int sectorCount=36, int stackCount=18, bool smooth=true, int up=3, bool texture=false);
    ~Sphere() {}
...
// ctor
///////////////////////////////////////////////////////////////////////////////
Sphere::Sphere(float radius, int sectors, int stacks, bool smooth, int up, bool tex) : interleavedStride(32)
{
...
void Sphere::setupVAO() {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(GL_FLOAT)*interleavedVertices.size(), interleavedVertices.data(), GL_STATIC_DRAW);
        ...
        glVertexAttribPointer(
            ...
            GL_TRUE,                         // normalized?
            interleavedStride,                                // stride
            (void*) (sizeof(GL_FLOAT)*6)           // array buffer offset
        );
...
void Sphere::draw() const
{
    ...
    //NOT SUPPORTED RIGHT NOW on CORE
    exit(1);
    return;
